...
router.get("/", authMiddleware, (req: CustomRequest, res: Response) => {
  try {
    const user = req.user!;
...
router.post("/", authMiddleware, (req: CustomRequest, res: Response) => {
  try {
    const user = req.user!;
...
router.delete("/", authMiddleware, (req: CustomRequest, res: Response) => {
  try {
    const user = req.user!;
